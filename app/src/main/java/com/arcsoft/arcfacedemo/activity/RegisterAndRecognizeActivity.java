...
import com.arcsoft.arcfacedemo.common.MainRc;
...
public class RegisterAndRecognizeActivity extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    final List<MainRc> faceDataSource  = Collections.synchronizedList(new LinkedList<MainRc>());
    /** compared with {@code ArrayList} the add and delete relatively fast */
    final List<MainRc> faceDisplayList = Collections.synchronizedList(new LinkedList<MainRc>());
    /**
    ...
    private void initView(){
        ...
        main_rv.setLayoutManager(new LinearLayoutManager
                (this,LinearLayoutManager.HORIZONTAL,false));
        main_rv.setItemAnimator(new SlideInRightAnimator());
        main_rv.getItemAnimator().setAddDuration(400);

        main_rv_list.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false));

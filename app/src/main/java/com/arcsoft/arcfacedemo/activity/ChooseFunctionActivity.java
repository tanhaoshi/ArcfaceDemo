...
public class ChooseFunctionActivity extends AppCompatActivity {
     ...
     * @param view
     */
    public void jumpToRegisterFaceActivity(View view){
        startActivity(new Intent(this,RegisterFaceActivity.class));
    }

    public void jumpToFaceRecognitionActivity(View view){
        startActivity(new Intent(this,FaceRecognitionActivity.class));
    }

    public void clearFaceDb(View view){
        RegisterInfoManager.getInstance().clearRegisterFace();
        Toast.makeText(this,getString(R.string.clear_face_database),Toast.LENGTH_SHORT).show();
    }
